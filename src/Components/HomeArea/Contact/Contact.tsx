                ...
                <div className="flex flex-col md:flex-row md:space-x-12">
                    ...
                    >
                        ...
                        <button
                            ...
                            cursor-pointer self-center md:self-start bg-[#10b981] !disabled:hover:bg-[#0eab72] transition duration-300 ease-in text-white font-medium py-3 px-8 rounded-lg"
                        >
                            {loading ? (
