...
export function Footer(): JSX.Element {
    ...
    // for light mode
    const lightModeLinkClasses = "text-[#10b981] hover:text-[#e5e7eb] transition-colors duration-200 px-3 py-2 cursor-pointer"
    const lightModeiconClasses = "text-[#10b981] hover:text-[#e5e7eb] transition-colors duration-200 px-2 py-2"
        ...
        <footer className="bg-[#0b1a3a]">
            <div className="max-w-4xl mx-auto px-4 py-8">
                ...
                <nav className="flex justify-center items-center flex-wrap space-x-4">
                    <span onClick={() => scrollToSection("home")} className={themeCtx.theme === "dark" ? linkClasses : lightModeLinkClasses}>Home</span>
