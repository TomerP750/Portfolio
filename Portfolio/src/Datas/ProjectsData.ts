...
import barberShopImage from "../../src/assets/barberShopImage.jpg"
...
export const projectsData: Project[] = [
    ...
    new Project(5, "Barber Shop", "Content", [ProjectType.FULLSTACK], ["Java", "Spring", "MySQL", "React"," TypeScript", "Tailwind CSS"],"","",barberShopImage),

    new Project(6, "TDEE Calculator", "", [ProjectType.FULLSTACK], ["Java", "Spring", "MySQL", "React"," TypeScript", "Tailwind CSS"], "","", tdeeImage),

    // TODO fix this making a bug VVV
    // new Project(7, "Serenify", "content", [ProjectType.FULLSTACK], ["Java", "Spring", "MySQL", "React"," TypeScript", "Tailwind CSS", "WebSocket"], "","")
